...
<div class="animate-fadeIn">
    <div class="mb-6">
        ...
        <h1 class="text-3xl font-bold text-slate-800 flex items-center space-x-3">
            <i class="ph ph-user-plus text-emerald-600"></i>
            <span>Nuevo Programador</span>
        </h1>
    </div>

    <div class="bg-white rounded-xl shadow-lg border border-slate-200 p-8 max-w-3xl">
        <form method="POST" action="index.php?controller=programadores&action=store" class="space-y-6">
            <div class="space-y-2">
            ...
            <div class="space-y-2">
                ...
                <input type="email" id="email" name="email" 
                       class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 outline-none"
                       placeholder="programador@email.com" required>
            </div>
            ...
            <div class="space-y-2">
                ...
                <input type="text" id="especialidad" name="especialidad" 
                       class="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 outline-none"
                       placeholder="Ej: Backend PHP, Frontend JavaScript, Full Stack">
            </div>
